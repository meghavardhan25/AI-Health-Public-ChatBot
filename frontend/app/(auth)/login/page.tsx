    ...
    <div className="w-full max-w-md">
      <div className="rounded-2xl border border-[var(--border)] bg-white p-8 shadow-xl dark:bg-slate-800">
        <div className="mb-6 text-center">
          <h1 className="text-2xl font-bold text-[var(--foreground)]">{t("welcome_back")}</h1>
          <p className="mt-1.5 text-sm text-[var(--muted)]">{t("sign_in_account")}</p>
        </div>
        ...
        <p className="mt-5 text-center text-sm text-[var(--muted)]">
          {t("no_account")}{" "}
          <Link href="/signup" className="font-medium text-teal-600 hover:underline">{t("sign_up")}</Link>
        </p>
      </div>
    </div>
  );
